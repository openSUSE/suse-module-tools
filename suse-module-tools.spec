...
install -pm 755 -t "%{buildroot}/usr/lib/module-init-tools/" \
	weak-modules2 driver-check.sh unblacklist lsinitrd-quick get_dracut_drivers rndis-tethering-check
...
install -pm 644 sysconfig.suse-module-tools %{buildroot}%{_fillupdir}/sysconfig.suse-module-tools
...
/usr/lib/module-init-tools/rndis-tethering-check
%{_unitdir}/*.service
%{_unitdir}/systemd-sysctl.service.d
%{_modulesloaddir}
%{_udevrulesdir}
/usr/lib/udev/remount-tmpfs
%{_fillupdir}/sysconfig.suse-module-tools
%dir %{dracutlibdir}
